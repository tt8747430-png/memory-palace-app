...
export function RoomJourney({ palaceId, roomId, roomTitle, palaceTitle, mode, nodes }: Props) {
  ...
  if (!current) {
    return (
      <div className="-mx-4 -my-6 flex min-h-[calc(100dvh-3.5rem-3rem-var(--height-bottom-nav)-env(safe-area-inset-bottom))] flex-col items-center justify-center gap-4 p-8 text-center sm:-mx-6 md:min-h-dvh lg:-mx-8">
