...
**Task:**
I need you to design and implement the Phase 4 based on the provided requirements from ROADMAP-aspirational.md. Your goal is to deliver an enterprise-grade solution that is structurally sound, highly performant, and leverages the absolute latest features of the specified frameworks.
...
- Requirements: Implement the Phase 4.
- Language/Environment: Next.js 16.2.4+, React 19.2.5
