...
export function RoomJourney({ palaceId, roomId, roomTitle, palaceTitle, mode, nodes }: Props) {
  ...
  if (!current) {
    return (
      <div className="-mx-4 -my-6 flex min-h-[calc(100svh-3.5rem-var(--height-bottom-nav))] flex-col items-center justify-center gap-4 p-8 text-center sm:-mx-6 md:min-h-svh lg:-mx-8">
