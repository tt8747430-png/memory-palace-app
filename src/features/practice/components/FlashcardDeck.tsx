...
export function FlashcardDeck({ nodes }: Props) {
  ...
  if (nodes.length === 0) {
    return (
      <div className="-mx-4 -my-6 flex min-h-[calc(100svh-3.5rem-3rem-var(--height-bottom-nav)-env(safe-area-inset-top)-env(safe-area-inset-bottom))] flex-col items-center justify-center gap-3 p-8 text-center sm:-mx-6 md:min-h-svh lg:-mx-8">
