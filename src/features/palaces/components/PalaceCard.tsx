  ...
  return (
    <Card
      className={[
        ...
        'shadow-[0_1px_0_inset_rgba(255,255,255,0.5),0_1px_2px_rgba(0,0,0,0.04),0_8px_24px_-8px_rgba(0,0,0,0.08)]',
        'dark:shadow-[0_1px_0_inset_rgba(255,255,255,0.06),0_1px_2px_rgba(0,0,0,0.4),0_12px_32px_-12px_rgba(0,0,0,0.6)]',
        'transition-all duration-300 ease-out',
        'hover:-translate-y-0.5 hover:shadow-[0_1px_0_inset_rgba(255,255,255,0.6),0_2px_4px_rgba(0,0,0,0.04),0_18px_40px_-12px_rgba(0,0,0,0.12)]',
        'dark:hover:shadow-[0_1px_0_inset_rgba(255,255,255,0.08),0_2px_4px_rgba(0,0,0,0.5),0_24px_48px_-12px_rgba(0,0,0,0.7)]',
      ].join(' ')}
    >
